...
const Sidebar = ({ role, setView, currentView, onSearch, onPlaylistClick }) => {
  ...
  return (
    <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' }}>
      ...
      <h2 className="desktop-only" style={{ marginBottom: '40px', fontSize: '24px', fontWeight: '700', letterSpacing: '-0.5px', background: 'linear-gradient(to right, #fff, #94a3b8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
        DC Music.
      </h2>
